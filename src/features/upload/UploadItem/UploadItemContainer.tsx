...
const UploadItemContainer = ({ children, squash, highlight }: Props) => {
  const classes = clsx(
    'grid grid-cols-upload lg:gap-8 md:gap-4 gap-2 py-5 px-5 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 items-center',
    highlight
      ? 'border-dashed border-2 border-pink'
      : 'dark:border-gray-800 border-b-2'
  );
